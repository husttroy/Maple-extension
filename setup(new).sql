...
create table patterns(id int auto_increment primary key, class varchar(256), method varchar(256), pattern varchar(256), support int, isRequired BOOLEAN, description varchar(256), votes int default 0); 
